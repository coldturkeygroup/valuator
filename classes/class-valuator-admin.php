...
class Valuator_Admin {
	...
	{
		echo '<p>' . __( 'These are a few simple settings for settings up your home valuation pages. <br> <a href="https://www.youtube.com/watch?v=eTOaHOoPY_Q" target="_blank">Watch our video about setting up your API keys.</a>', 'valuator' ) . '</p>';
	}
