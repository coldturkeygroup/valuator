...
class Valuator_Admin
{
    ...
    public function register_settings()
    {
        ...
        add_settings_field('pf_valuator_frontdesk_key', __('Platform CRM API key:', 'pf_valuator'), [
            $this,
            'frontdesk_key_field'
        ], 'pf_valuator', 'customize');
    ...
    public function frontdesk_key_field()
    {
        ...
        echo '<input id="frontdesk_key" type="text" name="pf_valuator_frontdesk_key" value="' . $data . '"/>
					<label for="frontdesk_key"><span class="description">' . __('Enter your API key generated by Platform CRM. To access your API key, visit <a href="https://platformcrm.com/account/api" target="_blank">https://platformcrm.com/account/api</a>.', 'pf_valuator') . '</span></label>';
        ...
        <div class="wrap" id="pf_valuator_leads">
            ...
            <ul id="settings-sections" class="subsubsub hide-if-no-js" style="margin-bottom:15px;">
                ...
                <li><a class="tab <? if (isset($_GET['lead_type'])) {
                        echo 'current';
                    } ?>" href="edit.php?post_type=pf_valuator&page=pf_valuator_leads&lead_type=complete">Complete Leads</a>
                </li>
            </ul>
