...
class Valuator_Admin
{
    ...
    public function frontdesk_key_field()
    {
        ...
        echo '<input id="frontdesk_key" type="text" name="pf_valuator_frontdesk_key" value="' . $data . '"/>
					<label for="frontdesk_key"><span class="description">' . __('Enter your API key generated by Platform CRM. To access your API key, visit <a href="https://platformcrm.com" target="_blank">https://platformcrm.com</a>.', 'pf_valuator') . '</span></label>';
