...
class Valuator_Admin {
	...
	public function add_menu_item() {
		add_submenu_page( 'edit.php?post_type=valuator' , 'Home Valuation Settings' , 'Settings', 'manage_options' , 'valuator_settings' , array( $this , 'settings_page' ) );
	}
	...
	public function admin_notice_actions() {
		if( isset( $_GET['valuator_hide_notice'] ) ) {
			...
			switch( esc_attr( $_GET['valuator_hide_notice'] ) ) {
				case 'zillow': add_user_meta( $user_id, 'valuator_hide_zillow_notice', true ); break;
			}
	...
	public function register_settings() {
		...
		add_settings_section( 'customize' , __( 'Basic Settings' , 'valuator' ) , array( $this , 'main_settings' ) , 'valuator' );

		// Add settings fields
		add_settings_field( 'valuator_slug' , __( 'URL slug for home valuation pages:' , 'valuator' ) , array( $this , 'slug_field' )  , 'valuator' , 'customize' );
		add_settings_field( 'valuator_zillow_key' , __( 'Zillow API key:' , 'valuator' ) , array( $this , 'zillow_key_field' )  , 'valuator' , 'customize' );
		add_settings_field( 'valuator_frontdesk_key' , __( 'FrontDesk API key:', 'valuator') , array( $this , 'frontdesk_key_field' ) , 'valuator' , 'customize' );
	...
	public function main_settings() { echo '<p>' . __( 'These are a few simple settings for settings up your home valuation pages.' , 'valuator' ) . '</p>'; }
	...
	public function feed_standard() {
		$rss_url = $this->home_url . '?feed=valuator';
		echo $rss_url;
	}
