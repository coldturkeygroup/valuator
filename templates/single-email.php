...
<head>
	...
	<title>New Home Valuator Submission</title>
	<style type="text/css">
		#outlook a {
			padding: 0;
		}
...
<span class="preheader" style="color:transparent;display:none ;visibility:hidden;opacity:0;height:0;width:0;">You have a new Home Valuator submission - here is their info:</span>
	    ...
	    Prospect Responses</h3></span>
                    ...
                    <span class="notlook">
                      <p>
	                      ...
	                      <?php if ( isset( $subscriber->address2 ) && $subscriber->address2 != '' ) { ?>
		                      <strong>Address Line 2: </strong><?= $subscriber->address2 ?><br>
	                      <?php } ?>
	                      <strong>Estimated Value: </strong><?= $subscriber->property_estimate ?><br>
                      </p>
                    </span>
									</td>
								</tr>
